...
public class PlayerTestWindow : EditorWindow
{
    ...
    [MenuItem("Tests/Player Test")]
    public static void ShowWindow()
    {
        GetWindow<PlayerTestWindow>("Player Test");
    }
    ...
    private void OnGUI()
    {
        ...
        {
            if (GUILayout.Button("Start Player Test (Instantiate Player, Striker, Coins)"))
            {
                StartPlayerTest();
            }
        }
